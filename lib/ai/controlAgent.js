...
export async function controlAgent(userRequest,chatHistory,userProfileInfo,clientDate,clientTime) {
  const prompt = getControlAgentPrompt(userRequest,chatHistory,userProfileInfo,clientDate,clientTime);
