...
- If the user asks about weather for a **specific, different location** not matching their current location extract the location name and pass it to the "cityName" field.
- If the user asks for a weather forecast **extending beyond 3 days** (e.g., "weather for next week", "10-day forecast", "weather in 5 days"), use "generalQuestionWithWebSearch".`
        ...
        (One of the flowMap keys),
                ...
                userMetaData: {
                    ...
                    "cityName": "(Optional, string) Extracted city name if explicitly mentioned for weatherQuestion. It must be English."
                }
            }`,
            examples: `
