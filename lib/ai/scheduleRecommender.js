...
export async function getScheduleRecommendations({message,schedules,selectedDays,userProfile}){
    try {
        const prompt = getScheudleRecommederPrompt(message,schedules,selectedDays,userProfile);
