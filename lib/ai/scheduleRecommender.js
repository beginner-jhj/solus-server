...
import { formatStandardResponse } from "./responseFormatter.js"; // Corrected path
...
export async function getScheduleRecommendations({message,schedules,selectedDays}){
    try {
        ...
        return formatStandardResponse(
            "error",
            "I encountered an issue while trying to generate schedule recommendations. Please try again later.",
            "schedule_recommendation_list",
            { recommendations: [] },
            "scheduleRecommender"
        );
