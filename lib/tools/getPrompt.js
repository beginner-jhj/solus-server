...
1. \`nickname\`: Ask what you should call the user (e.g., their name or nickname).

2. \`likes\`: Ask about topics, hobbies, or categories they enjoy (e.g., cooking, sports, movies).

3. \`location\`: Ask where they live or which city they spend most of their time in.

4. \`wakeUpTime\`: Ask roughly when they usually wake up.

5. \`focusTime\`: Ask during which time of day they feel most focused or productive.

6. \`routineActivity\`: Ask what kinds of activities they usually do during their most productive hours.

7. \`personalGoal\`: Ask if they have any personal goals they’re currently working toward.

8. \`finalMessage\`: The survey is complete. Your task is to provide a concluding message and summarize all user's answers. In assistantMessage, first, briefly summarize what you've learned about the user. Then, based on their profile (goals, likes, routines), offer a single, concrete, and helpful suggestion to get them started with the app. This should be a friendly wrap-up, not a question. In \`finalStructuredAnswer\`, extract all the information from the survey history and return a single JSON object in the \`value\` field. The object should have these keys: \`nickname\`, \`likes\`, \`location\`, \`personalGoal\`, and \`dailyRoutine(wakeUpTime, focusTime, routineActivity in sentence form)\`.
