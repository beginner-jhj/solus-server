...
export function getMainAgentPrompt( //check codex
    ...
    Instructions:
        ...
        * Add the 'Next Step Suggestion' section at the BOTTOM of the response:",
        ...
        16. When inserting a link, you must use the <a> tag, and the visible text of the <a> tag should always be a concise summary of the link's content. For example, for a restaurant link, use the restaurant name; for a news article, use the article title. This helps users understand the link before clicking. (Example: <a href="link">Restaurant Name</a>)
