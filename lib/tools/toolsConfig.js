...
const recommendScheduleConfig = {
    ...
    const completeOrDeleteScheduleEventConfig = {
    ...
    const updateUserProfileConfig = {
      ...
      description: `
      Update the user's profile information with new details learned from conversation. 
      Provide only the fields that changed. 
      The likes structure should be [[categoryName,[item1,item2]],...]
      Update based on the already stored information.

      Examples:
        User: I like to play basketball.
        Already stored: {likes: [["Sports",["Soccer"]] ]}
        Answer: {likes: [["Sports",["Basketball","Soccer"]] ]}

        User: I am currently concentrating on my studies.
        Already stored: {personalGoal: "Improve my health"}
        Answer: {personalGoal: "User's personal goal is to improve their health. User is currently concentrating on their studies."}

        User: I completed my studies.
        Already stored: {personalGoal: "Improve my health"}
        Answer: {personalGoal: "User's personal goal is to improve their health. User has completed their studies."}
      `,
      parameters: {
        type: Type.OBJECT,
        properties: {
...
return [
  ...
  completeOrDeleteScheduleEventConfig,
